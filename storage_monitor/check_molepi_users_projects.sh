...
du -h --max-depth=1 /exports/molepi/MOLEPI_PROJECTS/ | sort -hr > logs/molepi_research_projects.log
sh git_push.sh molepi_research_projects.log
du -h --max-depth=1 /exports/molepi/users/ | sort -hr  > logs/molepi_research_users.log
sh git_push.sh molepi_research_users.log
#sh git_push.sh
